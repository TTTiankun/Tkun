...
def convert_labelme_to_yolo_keypoints(json_file_path, output_dir, class_map=None):
    ...
    for shape in data['shapes']:
        ...
        if label == 'FAN_point' or label == 'R_point':
            normalized_points = [normalize_point(point, image_width, image_height) for point in points]
...
# 使用示例
input_folder = '/home/jason/Desktop/yolov8-test/datasets/test_datatsets'
output_dir = '/home/jason/Desktop/yolov8-test/datasets/test_datatsets'
class_map = {'R': 0, 'FAN': 1}  # 将标签名称映射到类别ID
