...
# 使用示例
input_folder = '/home/jason/Desktop/yolov8-test/datasets/rx_datasets_plus/labels_json_plus/'
output_dir = '/home/jason/Desktop/yolov8-test/datasets/rx_datasets_plus/'
class_map = {'knife': 0, 'cancer': 1, 'person': 2, 'car': 3}  # 将标签名称映射到类别ID
