...
static const _SellBook_Request_type_support_symbol_names_t _SellBook_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_test_interfaces, srv, SellBook_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_test_interfaces, srv, SellBook_Request)),
  }
};
...
{
  return &::ros2_test_interfaces::srv::rosidl_typesupport_cpp::SellBook_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_test_interfaces, srv, SellBook_Request)() {
  return get_message_type_support_handle<ros2_test_interfaces::srv::SellBook_Request>();
}
...
static const _SellBook_Response_type_support_symbol_names_t _SellBook_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_test_interfaces, srv, SellBook_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_test_interfaces, srv, SellBook_Response)),
  }
};
...
{
  return &::ros2_test_interfaces::srv::rosidl_typesupport_cpp::SellBook_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_test_interfaces, srv, SellBook_Response)() {
  return get_message_type_support_handle<ros2_test_interfaces::srv::SellBook_Response>();
}
...
static const _SellBook_type_support_symbol_names_t _SellBook_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_test_interfaces, srv, SellBook)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_test_interfaces, srv, SellBook)),
  }
};
...
{
  return &::ros2_test_interfaces::srv::rosidl_typesupport_cpp::SellBook_service_type_support_handle;
}
